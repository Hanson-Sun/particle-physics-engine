...
function checksim() {
	...
	if (type == "cloth") {
		document.getElementById("stiffness").value = 1000000;
		...
		document.getElementById("stiffness").value = 10000000;
		document.getElementById("startsim").checked = false;
		runsim = false;
		canvas.getContext("2d").clearRect(0, 0, canvas.width, canvas.height);
		applychanges();
		...
		document.getElementById("Drag").value = 0;
		document.getElementById("stiffness").value = 80000;
		document.getElementById("startsim").checked = false;
		...
		document.getElementById("Drag").value = 0;
		document.getElementById("stiffness").value = 100;
